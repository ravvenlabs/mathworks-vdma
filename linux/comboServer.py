...
class MyApp(App):
    ...
    def main(self, name='world'):
        ...
        if self.simulink == True:
            ...
            self.simulinkMem = mmap.mmap(self.f1.fileno(), 1000, offset=0x43c60000)
            ...
            self.simulinkMem.write(struct.pack('l', 94))       # horizontal porch
            self.simulinkMem.seek(20)                        
            self.simulinkMem.write(struct.pack('l', 1000))     # vertical porch when reading from debug
        ...
        self.videoDisplay = VideoDisplayWidget(5, width=1504, height=960)
